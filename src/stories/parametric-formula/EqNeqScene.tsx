...
export const EqNeqScene: React.FC<EqNeqSceneProps> = ({ mode = 'story', val1, val2, onParam1Change, onParam2Change }) => {
  return (
    <FormulaLayout
      story={storyData}
      mode={mode}
    ...
    return (
      <group position={[0, 0, 0]}>
        ...
        <mesh position={[0, 0, 0.02]}>
          ...
          <meshStandardMaterial color={isGlass ? '#ec4899' : '#d97706'} transparent opacity={isGlass ? 0.4 : 0.95} roughness={isGlass ? 0.1 : 0.7} />
        </mesh>
      </group>
    );
      }}
