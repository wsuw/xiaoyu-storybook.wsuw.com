...
export const InvTrigScene: React.FC<InvTrigSceneProps> = ({ mode = 'story', val1, val2, onParam1Change, onParam2Change }) => {
  return (
    <FormulaLayout
      story={storyData}
      mode={mode}
    ...
    return (
      <group position={[0, 0, 0]}>
        ...
        <mesh position={[0, 1.0, 0]} rotation={[-angle, 0, 0]}>
          ...
          <meshStandardMaterial color="#eab308" metalness={0.3} />
        </mesh>
